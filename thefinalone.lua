...
}); Utils:Create({"Part", GLOBALASSETS}, {
	Name = "Ring",
	Anchored = true, CanCollide = false,
}); Utils:Create({"Part", GLOBALASSETS}, {
	Name = "DashPanel",
...
-----------------
-- ADD MODELS --
local MODELS = Utils:Create({"Folder", GLOBALASSETS}, {
	Name = "Models"
}); local invincyaya = Utils:Create({"Model", MODELS}, {
	Name = "Invincibility",
}); Utils:Create({"Part", invincyaya}, {
	Name = "RootPart",
	Anchored = true,
	CanCollide = false,
	Transparency = 1,
}); Utils:Create({"Folder", invincyaya.RootPart}, {
	Name = "Invincibility",
	--Anchored = true,
	--CanCollide = false,
	--Transparency = 1,
}); for i = 1,2 do Utils:Create({"ParticleEmitter", invincyaya.RootPart.Invincibility}, {Enabled = false}) end
invincyaya.PrimaryPart = invincyaya.RootPart

-----------------------------------------------------------------

local mshieldyaya = Utils:Create({"Model", MODELS}, {
	Name = "MagnetShield",
}); Utils:Create({"Part", mshieldyaya}, {
	Name = "Shield1",
	Anchored = true,
	CanCollide = false,
	Transparency = 1,
}); --for i = 1,2 do Utils:Create({"ParticleEmitter", mshieldyaya.Shield1}, {Color3 = ColorSequence.new(Color3.new(0, 1, 0))}) end

Utils:Create({"Folder", mshieldyaya.Shield1}, {Name = "Beams"})
...
Utils:Create({"Part", mshieldyaya}, {
	...
	CanCollide = false,
	Transparency = 1,
}); --for i = 1,2 do Utils:Create({"ParticleEmitter", mshieldyaya.Shield2}, {Color3 = ColorSequence.new(Color3.new(0, 1, 0))}) end

Utils:Create({"Folder", mshieldyaya.Shield2}, {Name = "Beams"})
...
Utils:Create({"Part", mshieldyaya}, {
	...
	CanCollide = false,
	Transparency = 1,
}); --for i = 1,2 do Utils:Create({"ParticleEmitter", mshieldyaya.Shield3}, {Color3 = ColorSequence.new(Color3.new(0, 1, 0))}) end

Utils:Create({"Folder", mshieldyaya.Shield3}, {Name = "Beams"})

mshieldyaya.PrimaryPart = mshieldyaya.Shield1

-------------------------------------------

local shieldyaya = mshieldyaya:Clone()
shieldyaya.Parent = MODELS
shieldyaya.Name = "Shield"

----------------

local jumpiballyas = Utils:Create({"Model", MODELS}, {
	Name = "JumpBall",
}); Utils:Create({"Part", jumpiballyas}, { -- i actually tried for this one
	Name = "Smear",
	Shape = "Ball",
	Size = Vector3.one * 4,
	Material = "Neon",
	...
	CanCollide = false,
	Transparency = 1,
}); jumpiballyas.PrimaryPart = jumpiballyas.Smear

-- spindashball

local spinballyas = jumpiballyas:Clone()
spinballyas.Parent = MODELS
spinballyas.Name = "SpindashBall"

local temp = spinballyas.Smear
temp.Name = "Frame1"

local bruhjjj = temp:Clone(); bruhjjj.Parent = temp.Parent; bruhjjj.Name = "Frame2"
local bruhjjj = temp:Clone(); bruhjjj.Parent = temp.Parent; bruhjjj.Name = "Frame3"
local bruhjjj = temp:Clone(); bruhjjj.Parent = temp.Parent; bruhjjj.Name = "Frame4"
local bruhjjj = temp:Clone(); bruhjjj.Parent = temp.Parent; bruhjjj.Name = "Frame5"

-- balltrail

local balltrailyas = jumpiballyas:Clone()
balltrailyas.Parent = MODELS
balltrailyas.Name = "BallTrail"
Instance.new("Folder", balltrailyas).Name = "Trail"

-------------

Utils:Create({"Folder", GLOBALASSETS}, {
	Name = "Animations"
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Fall",
	AnimationId = "rbxassetid://656115606",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Roll",
	...
	Name = "Land",
	AnimationId = "rbxassetid://901160519",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Idle",
	AnimationId = "rbxassetid://387947158",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Jog1",
	AnimationId = "rbxassetid://387947975",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Jog2",
	AnimationId = "rbxassetid://387947975",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Run",
	AnimationId = "rbxassetid://656118852",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Skid",
	AnimationId = "rbxassetid://616160636",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "RailCrouch",
	AnimationId = "rbxassetid://387947158",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	...
	Name = "SpringStart",
	AnimationId = "rbxassetid://707853694",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
	Name = "Spring",
	AnimationId = "rbxassetid://707853694",
}); Utils:Create({"Animation", GLOBALASSETS.Animations}, {
...
local roo = owner.Character.HumanoidRootPart
Utils:Create({"Trail", roo}, {
	Name = "RailSpeedTrail"
}); Utils:Create({"Beam", roo}, {
	Name = "KickBeam1"
}); Utils:Create({"Beam", roo}, {
	Name = "KickBeam2"
}); Utils:Create({"Folder", roo}, {
	Name = "Bottom"
}); Utils:Create({"ParticleEmitter", roo.Bottom}, {
	Name = "Skid",
	Enabled = false,
}); Utils:Create({"ParticleEmitter", roo.Bottom}, {
	Name = "Sparks",
...
local function importfione()
	...
	local function on_lua_error(failed, err)
		...
		--error(string.format('%s:%i: %s', src, line, err or ""), 0)
		error(src or "Could not find source" ..":" ..tostring(line or 0) ..": " ..err or "Could not find erorr")
	end
...
pcontrol.Object = {}; pcontrol.Object.DashPanel = importvalue(controlf.Object.DashPanel)
					  pcontrol.Object.DashRamp = importvalue(controlf.Object.DashRamp)
					  pcontrol.Object.DashRing = importvalue(controlf.Object.DashRing)
					  pcontrol.Object.HomingTest = importvalue(controlf.Object.HomingTest)
					  pcontrol.Object.ItemBox = importvalue(controlf.Object.ItemBox)
					  pcontrol.Object.RainbowRing = importvalue(controlf.Object.RainbowRing)
					  pcontrol.Object.Ring = importvalue(controlf.Object.Ring)
					  pcontrol.Object.Spiketrap = importvalue(controlf.Object.Spiketrap)
					  pcontrol.Object.SpilledRing = importvalue(controlf.Object.SpilledRing)
					  pcontrol.Object.Spring = importvalue(controlf.Object.Spring)
					  pcontrol.Object.init = importvalue(controlf.Object.init)

pcontrol.Player = {}; 
pcontrol.Player.Physics = {}; pcontrol.Player.Physics.SA1 = importvalue(controlf.Player.Physics.SA1)
							  pcontrol.Player.Physics.SA2 = importvalue(controlf.Player.Physics.SA2)
							  pcontrol.Player.Physics.SOA = importvalue(controlf.Player.Physics.SOA)

pcontrol.Player.Input = {};  pcontrol.Player.Input.TouchButton = importvalue(controlf.Player.Input.TouchButton)
							 pcontrol.Player.Input.TouchThumbstick = importvalue(controlf.Player.Input.TouchThumbstick)
							 pcontrol.Player.Input.init = importvalue(controlf.Player.Input.init)
...
function GetDefaultCharacterInfo()
	...
	-- issue with physics. physics dumper from player scrip!
	...
	local UNDUMPED = pcontrol.Player.Physics.SOA.Sonic
	local PHYS = {}
	for i, v in pairs(UNDUMPED) do
		local map = phys_dump_map[i]
		PHYS[map] = v
		print("Physics: set " ..tostring(map) .." to " ..tostring(v))
	end
	PHYS.height = 1
	PHYS.scale = .5
	PHYS.rad = PHYS.rad / 1.5
	...
	return {
		--physics = {slide_speed = PHYS[1], crash_speed = PHYS[2], run_speed = PHYS[3]},
		physics = PHYS,
		p = PHYS,
		assets = GLOBALASSETS,
		animations = animfake,
		animation_tracks = GLOBALASSETS.Animations:children(),
		portraits = {
		...
		--prev_animation = animfake["Rail"],
		reset_anim = true
	}
end

pcontrol.PlayerDraw = {}; pcontrol.PlayerDraw.BallTrail = importvalue(controlf.PlayerDraw.BallTrail)
						  pcontrol.PlayerDraw.Invincibility = importvalue(controlf.PlayerDraw.Invincibility)
						  pcontrol.PlayerDraw.JumpBall = importvalue(controlf.PlayerDraw.JumpBall)
						  pcontrol.PlayerDraw.MagnetShield = importvalue(controlf.PlayerDraw.MagnetShield)
						  pcontrol.PlayerDraw.Shield = importvalue(controlf.PlayerDraw.Shield)
						  pcontrol.PlayerDraw.SpindashBall = importvalue(controlf.PlayerDraw.SpindashBall)
						  pcontrol.PlayerDraw.init = importvalue(controlf.PlayerDraw.init)

pcontrol.PlayerReplicate = {}; pcontrol.PlayerReplicate.Peer = importvalue(controlf.PlayerReplicate.Peer)
							  pcontrol.PlayerReplicate.init = importvalue(controlf.PlayerReplicate.init)

--pcontrol.Player = {};

pcontrol.Sounds = Instance.new("Folder", script); pcontrol.Sounds.Name = "Sounds"
pcontrol.Player.FootstepSounds = Utils:NewSound(script, 1, 1, 1)
					  pcontrol.Player.Movement = importvalue(controlf.Player.Movement)
					  pcontrol.Player.Animation = importvalue(controlf.Player.Animation)
					  pcontrol.Player.Collision = importvalue(controlf.Player.Collision)
					  pcontrol.Player.LSD = importvalue(controlf.Player.LSD)
--					  pcontrol.Player.Movement = importvalue(controlf.Player.Movement)
					  pcontrol.Player.Acceleration = importvalue(controlf.Player.Acceleration)
					  pcontrol.Player.HomingAttack = importvalue(controlf.Player.HomingAttack)
					  pcontrol.Player.Ragdoll = importvalue(controlf.Player.Ragdoll)
					  pcontrol.Player.Rail = importvalue(controlf.Player.Rail)
					  pcontrol.Player.Sound = importvalue(controlf.Player.Sound)
					  pcontrol.Player.init = importvalue(controlf.Player.init)

-- Run scrip.

--pcontrol.init = {}; pcontrol.init.client = importvalue(controlf.init.client)

-- because importing it wouldnt work, i just run the script here.

print("loading client")

--local gyro = Instance.new("BodyGyro", owner.Character.HumanoidRootPart)
--gyro.MaxTorque = Vector3.new(1, 0, 1) * 100000
...
local player = game:GetService("Players").LocalPlayer
	...
	debug_gui.Parent = player:WaitForChild("PlayerGui"):WaitForChild("guifolder")
	print("got playergui")
	...
	local music_class = pcontrol.Music
	...
	--Game initialization
	print("trying to get player replicate")
	player_replicate_instance = player_replicate_class:New()
	print("trying to get hud")
	hud_instance = hud_class:New(player:WaitForChild("PlayerGui"):WaitForChild("guifolder"))
	print("got playergui (again)")
	...
	--local temprotpart = Instance.new("Part")
	run_service.Stepped:connect(function()
		--temprotpart.CFrame = player_object.ang
		--player.Character.HumanoidRootPart.CFrame = player_object.supersecrethrp
		player.Character.HumanoidRootPart.CFrame = player_object.supersecrethrp
	end)

	run_service:BindToRenderStep("ControlScript_DebugDisplay", Enum.RenderPriority.Last.Value, function(dt)
		-- set rootpart pos (added in manually)
